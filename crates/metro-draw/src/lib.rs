//! Core data model for a diagrammatic city metro topology.
//!
...
//! schema and is available for exchanging topologies with web applications.
...
pub use topology_render::{TopologyRenderError, render_topology_svg, validate_topology};
...
/// `serde_yaml` emits all sequences in block style. TopologyPosition is the one place
